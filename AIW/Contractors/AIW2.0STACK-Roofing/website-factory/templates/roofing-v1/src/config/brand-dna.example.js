...
export const brandDNA = {
  ...
  // serviceAreas / service_areas -- both keys supported.
  // ARRAY OF STRINGS (city names). Components render each entry directly.
  serviceAreas: [],
  service_areas: [],
  ...
  copy: {
    ...
    // Roofing-niche extended copy sections
    insurance: {
      label: "__REQUIRED__INSURANCE_LABEL__",
      heading: "__REQUIRED__INSURANCE_HEADING__",
      body: "__REQUIRED__INSURANCE_BODY__",
      bullets: [],
      ctaText: "__REQUIRED__INSURANCE_CTA__",
      stat1Value: null,
      stat1Label: null,
      stat2Value: null,
      stat2Label: null,
    ...
    finalCta: {
      label: "__REQUIRED__FINALCTA_LABEL__",
      heading: "__REQUIRED__FINALCTA_HEADING__",
      subtext: "__REQUIRED__FINALCTA_SUBTEXT__",
      footnote: null,
    },

    footer: {
      tagline: "__REQUIRED__FOOTER_TAGLINE__",
    },

    about: {
      subtext: "__REQUIRED__ABOUT_SUBTEXT__",
      storyHeading: "__REQUIRED__ABOUT_STORY_HEADING__",
      storyParagraphs: [],
    },

    // buttonText is an object for niche templates that need multiple CTA labels
    buttonText: {
      getEstimate: "__REQUIRED__BTN_GET_ESTIMATE__",
      callNow: "__REQUIRED__BTN_CALL_NOW__",
    },
  },
