...
export const brandDNAShape = {
  ...
  // ARRAY OF STRINGS (city names). Use plain strings, not objects.
  serviceAreas: [],
  service_areas: [],
  ...
  copy: {
    ...
    // Niche-extended copy sections (optional at universal shape level;
    // niche templates populate these from their niche playbook).
    insurance: {
      label: null,
      heading: null,
      body: null,
